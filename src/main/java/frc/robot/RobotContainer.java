...
public class RobotContainer {
  ...
  public final Claw_Sub m_Claw_Sub = new Claw_Sub(m_driverController.getHID());
  ...
  private void configureBindings() {
    ...
    // m_ClimberSub.climberMotor1.motor.getSupplyCurrent())));
    // m_driverController.a().onTrue(new InstantCommand(() ->
    // m_GameStateCurrentLimiter.SetState(GameStateCurrentLimiter.State.SHOOT)));
    // m_driverController.x().onTrue(new InstantCommand(() ->
    // m_GameStateCurrentLimiter.SetState(GameStateCurrentLimiter.State.CLIMB)));
    ...
    // m_driverController.axisMagnitudeGreaterThan(1, 0.1).whileTrue(new
    // ClawPercent_Com(m_Claw_Sub, -m_driverController.getLeftY()));
    ...
    // m_driverController.pov(0).onTrue(new L4_scoring_Com(m_Arm_Sub,
    // m_Elevator_Sub, 0, 0)
    ...
    // m_driverController.pov(180).onTrue(new L3_scoring_Com(m_Arm_Sub,
    // m_Elevator_Sub, 0, 0)
    // .andThen(new ClawPercent_Com(m_Claw_Sub, 0))
    // .andThen(new L3_scoring_Com(m_Arm_Sub, m_Elevator_Sub, 0, 0)));

    // // L2 scoring command button line
    // m_driverController.pov(90).onTrue(new L2_scoring_Com(m_Arm_Sub,
    // m_Elevator_Sub, 0, 0)
    // .andThen(new ClawPercent_Com(m_Claw_Sub, 0))
