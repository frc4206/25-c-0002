...
public class RobotContainer {
  ...
  private final ClimberSub.Config m_climbercfg = new ClimberSub.Config("Climber.toml");


  private final ExampleSubsystem m_exampleSubsystem = new ExampleSubsystem();
  private final ClimberSub m_ClimberSub = new ClimberSub(m_climbercfg);
  ...
  public RobotContainer() {
    ...
    m_GameStateCurrentLimiter.AddSubsystem(m_climbercfg.name, m_ClimberSub.m_climberList);
    m_GameStateCurrentLimiter.PopulateSubsystemLimits(m_climbercfg.name, m_ClimberSub.currentLimitList);
  }
