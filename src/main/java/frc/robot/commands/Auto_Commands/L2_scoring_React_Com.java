...
public class L2_scoring_React_Com extends ParallelCommandGroup {
  /** Creates a new L4_scoring_React_Com. */
  Elevator_Sub m_elevatorSub;
  Arm_Sub m_armSub;

  public L2_scoring_React_Com(Arm_Sub armSub, Elevator_Sub elevatorSub) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    m_armSub = armSub;
    m_elevatorSub = elevatorSub;
    addCommands(new Arm_PID_React_Com(m_armSub, m_armSub.armConfig.l2ScoringPosition), new Elevator_PID_React_Com(elevatorSub, elevatorSub.elevatorConfig.l2ScoringPosition));
  }
}
