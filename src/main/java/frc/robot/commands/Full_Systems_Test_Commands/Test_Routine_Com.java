...
public class Test_Routine_Com extends Command {
  ...
  Claw_Sub m_clawSub;
  Arm_Sub m_armSub;
  /** Creates a new Test_Routine_Com. */
  public Test_Routine_Com(Arm_Sub armSub, Claw_Sub clawSub, Elevator_Sub elevatorSub, Climber_Sub climberSub, Intake_Sub intakeSub) {
