...
public class Elevator_PID_React_Com extends Command {
  Elevator_Sub m_elevatorSub;
  double m_elevatorPosition;
  boolean isfin = false;
  /** Creates a new Elevator_PID_Com. */
  public Elevator_PID_React_Com(Elevator_Sub elevatorSub, double position) {
  ...
  @Override
  public void execute() {
    if (Math.abs(m_elevatorPosition - m_elevatorSub.elevatorMotor1.getPosition().getValueAsDouble()) < 0.7) {
      isfin = true;
      isFinished();
    }
  }
